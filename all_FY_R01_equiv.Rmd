...
PI_ALL_COUNT_PI %>% 
  ggplot(aes(x = FY, y = COUNT_PI, group = 1)) + geom_line(size = 2, colour = "#c0392b") + fte_theme() + labs(title="Number of unique investigators\nreceiving R01 equivalent funds per fiscal year", x="\nFiscal Year", y="Number of investigators\n") + geom_hline(yintercept=20000, size=0.4, color="black") + coord_cartesian(ylim = c(20000, 25000))
